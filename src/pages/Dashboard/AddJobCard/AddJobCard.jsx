        ...
        <div className='addJobCardWraps'>
           ...
           <div className="jobCardSingleForm jobCardSingleForm2 mt-8">
            ...
            <label>Car Registration No </label>
                <input className='registrationForm' autoComplete='off' type="text" placeholder='Car Registration No'/>
            </div>
            <div>
            ...
            <div>
                ...
                <input autoComplete='off' type="text" placeholder='Referance Number' />
            </div>
            <div>
           ...
           <div className="jobCardSingleForm">
            ...
            <label>Engine No </label>
                <input className='registrationForm' autoComplete='off' type="text" placeholder='Engine No ' />
            </div>
            <div>
                <label>Color</label>
           ...
           <div className="jobCardSingleForm">
            <div>
                ...
                <input autoComplete='off' type="text" placeholder='Customer/User name ' />
            </div>
            <div>
            <label>Contact No </label>
                <input className='registrationForm' autoComplete='off' type="text" placeholder='Contact No ' />
            </div>
            <div>
           ...
           <div className='mt-5 vehicleTextField'>
            <b className='block'> Vehicle Interior Parts, Papers, Tools, Meter Light & Others </b> 
            <textarea> </textarea>
           </div>
           <div className='vehicleReport'>
            ...
            <div className="vehicleReportRightSide">
                <b htmlFor="" className="block"> Vehicle Body Report (Mark with X where damage )</b>
           ...
           <div className="jobCardSingleForm">
            <div>
                ...
                <input autoComplete='off' type="text" placeholder='Technician Name' />
            </div>
            <div>
            <label>Technician Signature </label>
                <input className='registrationForm' autoComplete='off' type="text" placeholder='Technician Signature' />
            </div>
            <div>
                <label>Date </label>
            ...
            <div>
                ...
                <input autoComplete='off' type="text" placeholder='For Vehicle Owner' />
            </div>
           </div>
           <div>
