                  ...
                  >
                    <div className="">
                      <div className="flex mb-5 items-center justify-between">
                        ...
                        <button
                          onClick={handleClose}
                          className="bg-red-500 text-white px-3 py-2 rounded-sm ml-2"
                        >
                          X
                        </button>
                      </div>
                      ...
                      <div className="mt-3">
                        <div className="flex items-center">
                          ...
                          <TextField className="carRegNo" label="Car R (T&N)" />
                        </div>
                      </div>
                      <div className="mt-3">
                        <TextField
                    ...
                    <button className="bg-[#42A1DA] text-white rounded-md px-5 py-2 w-52 mx-auto my-5">
                      Add Job Card{" "}
                    </button>
                  </Typography>
                </Box>
